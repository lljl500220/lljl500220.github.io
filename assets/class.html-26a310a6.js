import{_ as n,V as s,W as a,a2 as e}from"./framework-82b537ca.js";const t={},p=e(`<h2 id="class的基本使用" tabindex="-1"><a class="header-anchor" href="#class的基本使用" aria-hidden="true">#</a> class的基本使用</h2><p>在es6中，class是一个语法糖，它的本质是函数，所以我们可以使用class来构建一个类，然后使用new关键字来实例化一个对象。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Animal</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这段代码中，我们使用abstract关键字来实现抽象类，这样我们就可以使用抽象类来实现抽象方法，然后使用子类来继承父类的属性和方法。</p>`,24),c=[p];function i(o,l){return s(),a("div",null,c)}const d=n(t,[["render",i],["__file","class.html.vue"]]);export{d as default};
