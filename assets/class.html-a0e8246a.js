import{_ as n,O as s,P as a,a7 as e}from"./framework-ddc72b3a.js";const t={},p=e(`<h2 id="class的基本使用" tabindex="-1"><a class="header-anchor" href="#class的基本使用" aria-hidden="true">#</a> class的基本使用</h2><p>在es6中，class是一个语法糖，它的本质是函数，所以我们可以使用class来构建一个类，然后使用new关键字来实例化一个对象。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Animal</span> <span class="token punctuation">{</span>
