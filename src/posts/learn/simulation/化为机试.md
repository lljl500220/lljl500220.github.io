...
```
## HJ16 购物单
[原题由此去](https://www.nowcoder.com/practice/f9c6f980eeec43ef85be20755ddbeaf4?tpId=37&tqId=21239&rp=1&ru=/exam/oj/ta&qru=/exam/oj/ta&sourceUrl=%2Fexam%2Foj%2Fta%3FtpId%3D37&difficulty=undefined&judgeStatus=undefined&tags=&title=)

::: info 相关信息和分析
首先明确这题其实是一道动态规划的题目，近乎01背包的问题  
[动态规划的更多内容请看这篇文章](dp.md)  
再着眼于这道题，由于多了附件这个玩意，所以对情况进行划分
...
相较于一般的01背包问题，该题在公式上将要比较以上四个内容的大小，并改变装入背包的物品数量。
:::
